...
#import "LKNetWorkManager.h"

#import <AVFoundation/AVAsset.h>
#import <AVFoundation/AVAssetExportSession.h>
#import <AVFoundation/AVMediaFormat.h>

@implementation LKNetWorkManager
...
+(instancetype)shareManager
{
    ...
    static LKNetWorkManager * manager = nil;
...
+(void)requestWithType:(HttpRequestType)type withUrlString:(NSString *)urlString withParaments:(id)paraments withSuccessBlock:(requestSuccess)successBlock withFailureBlock:(requestFailure)failureBlock progress:(downloadProgress)progress
{
    ...
    switch (type) {
        ...
        case HttpRequestTypeGet:
        {
            ...
            [[LKNetWorkManager shareManager] GET:urlString parameters:paraments progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            
        {
            ...
            [[LKNetWorkManager shareManager] POST:urlString parameters:paraments progress:^(NSProgress * _Nonnull uploadProgress) {
...
+(void)cancelAllRequest
{
    ...
    [[LKNetWorkManager shareManager].operationQueue cancelAllOperations];
...
+(void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string
{
    ...
    NSString * urlToPeCanced = [[[[LKNetWorkManager shareManager].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
    
    
    for (NSOperation * operation in [LKNetWorkManager shareManager].operationQueue.operations) {
